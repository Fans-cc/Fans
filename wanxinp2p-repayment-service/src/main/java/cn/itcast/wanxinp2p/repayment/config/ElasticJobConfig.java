...
import cn.itcast.wanxinp2p.repayment.job.RepaymentJob;
...
public class ElasticJobConfig {
    ...
    public SpringJobScheduler initSimpleElasticJob(){
        SpringJobScheduler springJobScheduler = new SpringJobScheduler(repaymentJob,zookeeperRegistryCenter,createJobConfiguration(repaymentJob.getClass(),cron,shardingCount));
