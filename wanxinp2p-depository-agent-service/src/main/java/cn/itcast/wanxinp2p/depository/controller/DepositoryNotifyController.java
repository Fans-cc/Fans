...
public class DepositoryNotifyController {
    ...
    @Autowired
    GatewayMessageProducer gatewayMessageProducer;
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "platformNo", value = "平台编号，平台与存管系统签约时获 取", required = true, dataType = "String", paramType = "query"),
